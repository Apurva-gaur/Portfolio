  ...
  return (
    <div className="text-white flex w-full items-center p-10 md:p-15  gap-4 md:flex-col flex-col">
      ...
      <div className=" md:w-2/4 md:pt-0  flex-col justify-items-center">
        <h1 className="text-xl md:text-6xl font-bold flex leading-normal tracking-tighter shadow-xl text-center ">
          Hello! I am Apurva Singh
        </h1>
        <p className=" mt-1 text-sm md:text-2xl tracking-tight text-center ">
        ...
        <button
          className=" ml-5 mt-5 md:md-10 text-white py02 px-3 text-sm md:text-lg md:py-2 md:px-4 hover:opacity-85 duration-300 hover:scale-105 font-semibold rounded-3xl bg-[#465697]"
      ...
      <div className=" w-2/4 flex flex-wrap gap-10 text-4xl  justify-center items-center" >
